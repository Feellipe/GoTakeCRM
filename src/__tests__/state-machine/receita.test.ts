...
describe('/receita — Step 0: Ask project ID', () => {
  it('asks for project ID on first call (input ignored)', async () => {
    const result = await receitaHandler.handle('', {}, 0);
  ...
  it('ignores any input text at step 0', async () => {
    const result = await receitaHandler.handle('qualquer coisa', {}, 0);
...
describe('/receita — Step 1: Validate project ID', () => {
  it('accepts valid project ID and asks for value', async () => {
    ...
    const result = await receitaHandler.handle('deal-1', {}, 1);
  ...
  it('rejects empty project ID', async () => {
    const result = await receitaHandler.handle('', {}, 1);
  ...
  it('rejects project ID when deal not found', async () => {
    ...
    const result = await receitaHandler.handle('nonexistent-id', {}, 1);
...
describe('/receita — Step 2: Receive value', () => {
  ...
  it('accepts valid numeric value and asks for description', async () => {
    const result = await receitaHandler.handle('5000', dataWithProject, 2);
  ...
  it('accepts value 0.01 (lower boundary)', async () => {
    const result = await receitaHandler.handle('0,01', dataWithProject, 2);
  ...
  it('rejects value 0', async () => {
    const result = await receitaHandler.handle('0', dataWithProject, 2);
  ...
  it('rejects negative value', async () => {
    const result = await receitaHandler.handle('-100', dataWithProject, 2);
  ...
  it('accepts R$ prefix', async () => {
    const result = await receitaHandler.handle('R$ 5000', dataWithProject, 2);
  ...
  it('accepts Brazilian format 1.500,50', async () => {
    const result = await receitaHandler.handle('1.500,50', dataWithProject, 2);
  ...
  it('rejects empty input', async () => {
    const result = await receitaHandler.handle('', dataWithProject, 2);
...
describe('/receita — Step 3: Receive description', () => {
  ...
  it('accepts valid description and asks for status', async () => {
    const result = await receitaHandler.handle('Pagamento da entrada', dataWithValue, 3);
  ...
  it('accepts 1-character description (lower boundary)', async () => {
    const result = await receitaHandler.handle('A', dataWithValue, 3);
  ...
  it('accepts 500-character description (upper boundary)', async () => {
    ...
    const result = await receitaHandler.handle(desc, dataWithValue, 3);

    expect(result.nextStep).toBe(4);
  });

  it('rejects empty description', async () => {
    const result = await receitaHandler.handle('', dataWithValue, 3);
...
describe('/receita — Step 4: Create revenue', () => {
  ...
  it('creates revenue with status "recebido"', async () => {
    ...
    const result = await receitaHandler.handle('recebido', dataReady, 4);
  ...
  it('creates revenue with status "pendente"', async () => {
    ...
    const result = await receitaHandler.handle('pendente', dataReady, 4);
  ...
  it('rejects invalid status', async () => {
    const result = await receitaHandler.handle('parcial', dataReady, 4);
  ...
  it('rejects empty status', async () => {
    const result = await receitaHandler.handle('', dataReady, 4);
...
describe('/receita — Edge cases', () => {
  it('handles invalid step number gracefully', async () => {
    const result = await receitaHandler.handle('test', {}, 99);
