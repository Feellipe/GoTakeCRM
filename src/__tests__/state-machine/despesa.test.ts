...
describe('/despesa — Step 0: Ask project ID', () => {
  it('asks for project ID on first call (input ignored)', async () => {
    const result = await despesaHandler.handle('', {}, 0, 'org-1');
  ...
  it('ignores any input text at step 0', async () => {
    const result = await despesaHandler.handle('qualquer coisa', {}, 0, 'org-1');
...
describe('/despesa — Step 1: Validate project ID', () => {
  it('accepts valid project ID and asks for value', async () => {
    ...
    const result = await despesaHandler.handle('deal-1', {}, 1, 'org-1');
  ...
  it('rejects empty project ID', async () => {
    const result = await despesaHandler.handle('', {}, 1, 'org-1');
  ...
  it('rejects project ID when deal not found', async () => {
    ...
    const result = await despesaHandler.handle('nonexistent-id', {}, 1, 'org-1');
...
describe('/despesa — Step 2: Receive value', () => {
  ...
  it('accepts valid numeric value and asks for description', async () => {
    const result = await despesaHandler.handle('5000', dataWithProject, 2, 'org-1');
  ...
  it('accepts value 0.01 (lower boundary)', async () => {
    const result = await despesaHandler.handle('0,01', dataWithProject, 2, 'org-1');
  ...
  it('rejects value 0 (invalid — must be positive)', async () => {
    const result = await despesaHandler.handle('0', dataWithProject, 2, 'org-1');
  ...
  it('rejects negative value', async () => {
    const result = await despesaHandler.handle('-100', dataWithProject, 2, 'org-1');
  ...
  it('accepts value with R$ prefix', async () => {
    const result = await despesaHandler.handle('R$ 5000', dataWithProject, 2, 'org-1');
  ...
  it('accepts Brazilian format 1.500,50', async () => {
    const result = await despesaHandler.handle('1.500,50', dataWithProject, 2, 'org-1');
  ...
  it('accepts Brazilian format with R$ and thousands separator', async () => {
    const result = await despesaHandler.handle('R$ 1.500,50', dataWithProject, 2, 'org-1');
  ...
  it('rejects non-numeric input', async () => {
    const result = await despesaHandler.handle('abc', dataWithProject, 2, 'org-1');
  ...
  it('rejects empty input', async () => {
    const result = await despesaHandler.handle('', dataWithProject, 2, 'org-1');
...
describe('/despesa — Step 3: Receive description', () => {
  ...
  it('accepts valid description and asks for category', async () => {
    const result = await despesaHandler.handle('Aluguel de câmera Sony A7III', dataWithValue, 3, 'org-1');
  ...
  it('accepts 1-character description (lower boundary)', async () => {
    const result = await despesaHandler.handle('A', dataWithValue, 3, 'org-1');
  ...
  it('accepts 500-character description (upper boundary)', async () => {
    ...
    const result = await despesaHandler.handle(desc, dataWithValue, 3, 'org-1');
  ...
  it('rejects empty description', async () => {
    const result = await despesaHandler.handle('', dataWithValue, 3, 'org-1');
...
describe('/despesa — Step 4: Create expense', () => {
  ...
  it('accepts valid category "equipamento" and creates expense', async () => {
    ...
    const result = await despesaHandler.handle('equipamento', dataReady, 4, 'org-1');
  ...
  it('accepts all valid categories', async () => {
    ...
    for (const cat of categories) {
      ...
      const result = await despesaHandler.handle(cat, dataReady, 4, 'org-1');
      expect(result.nextStep).toBeNull();
      expect(db.expense.create).toHaveBeenCalledWith(
  ...
  it('rejects invalid category', async () => {
    const result = await despesaHandler.handle('comida', dataReady, 4, 'org-1');
  ...
  it('rejects empty category', async () => {
    const result = await despesaHandler.handle('', dataReady, 4, 'org-1');
...
describe('/despesa — Edge cases', () => {
  it('handles invalid step number gracefully', async () => {
    const result = await despesaHandler.handle('test', {}, 99, 'org-1');
  ...
  it('handles non-numeric value like "mil" gracefully', async () => {
    const result = await despesaHandler.handle('mil', { projectId: 'deal-1' }, 2, 'org-1');
